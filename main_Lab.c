 ...
 * módulo ADC se pasa ADRESH al PORTC y PORTD según cada potenciómetro.
 *
 * Created on 19 de abril de 2022, 04:20 PM
 */
...
void __interrupt() isr(void){
    ...
    if (PIR1bits.ADIF){
        if (ADCON0bits.CHS == 0){ //Se verifica canal AN0        
            ...
            PORTD = ADRESH; //Se muestran los 8 bits superiores en PORTD
        }
